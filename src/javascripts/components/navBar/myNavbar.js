...
const myNavbar = (currentUser) => {
  $('#nav').html(
    ...
    <a class="navbar-brand" href="#">Sort of Pinterest</a>
    ...
    <li class="nav-item mx-3"  id="boards-link">
      <a id="add-board-link" class="nav-link" href="#"><i class="fas fa-lightbulb-off"></i> Boards</a>
    </li>
    ...
    <li class="nav-item mx-3"  id="add-pin-link">
      <a class="nav-link" href="#"><i class="fas fa-lightbulb-off"></i> Add A Pin</a>
    </li>
  </ul>
